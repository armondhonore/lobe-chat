...
**Live:** [https://relaxed-weasel-lobe-chat.cloud.nexlayer.ai](https://relaxed-weasel-lobe-chat.cloud.nexlayer.ai)  
...
**lobe-chat** is deployed on [Nexlayer](https://nexlayer.ai) — a container-native
...
application:
  ...
  pods:
  - name: app
    image: mirror.gcr.io/lobehub/lobe-chat:latest
    path: /
    servicePorts:
    - 3210
    vars:
      OPENAI_API_KEY: "sk-placeholder"
      ACCESS_CODE: "nexlayer2024"
